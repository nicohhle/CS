...
class IntList {
    ...
    public:
        ...
        friend ostream & operator<<(ostream &out, const IntList &rhs);//: A global friend function that outputs to the stream all of the integer values within the list on a single line, 
